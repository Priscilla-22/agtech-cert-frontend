...
export function FarmerActions({ farmer, onDelete }: FarmerActionsProps) {
  ...
  async function handleConfirmDelete() {
    try {
      ...
      toast({
        title: "Success",
        description: `${farmer.name} has been deleted successfully.`,
      })
    } catch (error) {
  ...
  return (
    <>
      ...
      <DeleteConfirmationModal
        ...
        title="Delete Farmer"
        description={`Are you sure you want to delete "${farmer.name}"? This action cannot be undone and will also delete all associated farms and data.`}
